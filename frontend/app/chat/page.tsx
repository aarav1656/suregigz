...
const initialMessages: Message[] = [
  ...
  {
    sender: "ai",
    text: "Here is the latest commit: Add payment integration. Would you like to review the code or make a payment?",
    time: "09:02 AM",
  },
];

const aiResponses = [
  "I am SureGigz AI, your project assistant! I can help you track progress, manage payments, and answer questions about your gigs.",
  ...
  "Want to see the latest commits for your project? Click Track on GitHub or ask me directly!",
];
